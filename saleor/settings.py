...
DATABASES = {
    DATABASE_CONNECTION_DEFAULT_NAME: dj_database_url.config(
        ...
        default=f"postgres://{os.environ.get('DB_USER_NAME', 'uname')}:{os.environ.get('DB_PASSWORD', 'dbpasswd')}@{os.environ.get('DB_HOST', 'dbhost')}:{os.environ.get('DB_PORT', '5432')}/{os.environ.get('DB_NAME', 'dbname')}?sslmode=require",
